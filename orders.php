...
<html>
  <head>
    ...
    <style>
      ...
      table{border-radius:5px; border-color:blue; width:100%; color:white;}
      th,td{border-radius:5px; text-align:center; color:white;}
      th{padding:1%;}
          ...
          <?php
            ...
            if($result && mysqli_num_rows($result)>0)
            {
              ...
              if($userinfo['desg']==2)
              {
                ...
                $rec = mysqli_query($con,"SELECT * FROM orders"); 
          ...
          <form method='post'>
            <fieldset>
              ...
              <table border="3" cellpadding=10>
                ...
                <?php
                $records = mysqli_query($con,"SELECT * FROM orders"); // fetch data from database
